// Roadmap — based on real Railwise release notes & wishlist discussion
...
const ROADMAP = [
  ...
  },
  {
    ...
    items: [
      ...
      { zh: 'install-source-aware railwise update', en: 'install-source-aware `railwise update`' },
  ...
  },
  {
    ...
    state: 'plan',
    items: [
      { zh: 'railwise init · 项目脚手架 CLI', en: 'railwise init · project scaffolder CLI' },
