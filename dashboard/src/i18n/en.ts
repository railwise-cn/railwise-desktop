export const en = {
  ...
  settings: {
    ...
    themeStyleEmberDesc: "Warm dark with a stronger Railwise orange accent.",
  ...
  overview: {
    ...
    standaloneDesc:
      "Read-only disk view. Start /dashboard from inside railwise code for live session state, MCP, and tools.",
    cockpit: "Cockpit",
    balance: "balance",
    tokens7d: "tokens · 7d",
    cacheHit: "cache hit",
    ...
    noSession: "No live session — /dashboard from inside railwise code to attach.",
  ...
  usage: {
    ...
    noData: "No usage data yet — run a turn in railwise chat / code / run and refresh.",
  ...
  sessions: {
    ...
    attachRequired:
      "Live session operations need an attached CLI session. Launch via railwise chat or open the dashboard from inside a TUI session.",
    activeChip: "active",
    activePill: "active",
  },
  tools: {
  ...
  permissions: {
    ...
    standaloneWarning:
      "Mutations require /dashboard from inside an active railwise code session — standalone railwise dashboard can't tell which project's allowlist to edit.",
  },
  mcp: {
    loading: "loading MCP…",
    ...
    saved: "saved",
    savedRestart: "saved — restart railwise code to bridge this server",
    ...
    whyUnbridgedDesc:
      "This spec lives in your config.json but isn't bridged into the live session. MCP servers attach when railwise code starts; the dashboard alone can't spawn the child process.",
    whyUnbridgedHint: "To activate: restart railwise code, then refresh this dashboard.",
    bridgeFailed: "Bridge failed",
    bridgeFailedTitle: "bridge failed · in config",
    bridgeFailedHint:
      "Railwise tried to bridge this server and the attempt errored. Common causes: wrong URL, missing auth header, upstream 404/5xx, missing local command. Fix and restart railwise code to retry.",
    ...
    marketplaceEnvHint:
      "Set these in your shell before next `railwise code` so the bridged server can authenticate.",
    marketplaceRestartHint:
      "Spec written to ~/.reasonix/config.json. Restart `railwise code` to bridge the server (live hot-reload is on the roadmap).",
  },
  memory: {
  ...
  hooks: {
    ...
    colScript: "script",
    noProject: "No active project — open /dashboard from railwise code to edit project hooks.",
  ...
  skills: {
    ...
    builtinDesc:
      "Built-in skills ship with Railwise; the model picks them up automatically. To customize, create a project- or global-scoped skill with the same name.",
  ...
  system: {
    ...
    built: "● built",
    none: "— none",
    runIndex: "run railwise index to build",
    usageLog: "usage log",
  ...
  semantic: {
    ...
    installOllamaDesc:
      "Railwise doesn't run package managers for you. Install Ollama first, then come back:",
    ...
    remoteProviderDesc:
      "Configure the full OpenAI-compatible embeddings URL here. Railwise will send requests exactly to the URL you provide.",
    ollama: "ollama",
    binary: "binary",
    found: "found",
    missing: "missing",
