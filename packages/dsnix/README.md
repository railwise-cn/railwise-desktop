...
Short alias for [`railwise`](https://www.npmjs.com/package/railwise) — the DeepSeek-native coding agent.
...
For docs, config, slash commands, and everything else, see the [main Railwise README](https://github.com/esengine/Railwise#readme).
