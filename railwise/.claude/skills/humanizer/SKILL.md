...
✅ 工程师风格：
> DB-03 测点本周期沉降量 2.1mm，较上周期（1.8mm）略有增大，累计达 15.3mm。考虑到该测点位于地铁保护区东南侧，邻近交通导改及管线迁改作业区域，沉降加速与近期施工扰动具有时空相关性。目前累计值占控制值的 51%，建议相关工序完成后加密观测 3 天，确认变形收敛后恢复正常频率。
...
对每个分析段落检查：
- [ ] 是否关联了施工工况？（"本周期正在进行交通导改、管线迁改或轨旁设备安装"）
...
测点B：位于地铁保护区北侧的 DB-05 累计沉降已达 22.1mm（控制值的 73.7%），本期变化量 1.5mm 为全场最大值，需重点关注。
