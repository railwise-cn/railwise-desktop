...
使用 `query_standard` 工具进行精确查询，该工具内置了轨道交通监测、变形测量和工程测量三类核心规范条文：

1. **按关键词查询**：`keywords: ["报警值", "轨道交通"]`
2. **按规范编号过滤**：`standardCode: "GB 50911"`
...
### 多规范对比引用
> 结合GB 50911第5.5.1条和JGJ 8变形测量精度要求，报警值应综合考虑设计文件、监测等级和规范限值。
