...
description: 工程监测方案设计专业技能包。当需要编制轨道交通保护区监测、铁路/交通测量监测或结构健康监测方案时加载此技能，获取规范要求、测点布设原则和仪器选型指引。
---
...
|---------|-----------|-------------------|--------|
| 轨道几何状态 | 5~20m 或按轨枕/扣件区段 | 必测/必测/选测 | 1次/天 |
| 轨道结构沉降 | 5~10m | 必测/必测/必测 | 1次/天 |
| 隧道收敛与水平位移 | 5~20m | 必测/必测/选测 | 1次/天 |
| 接触网/限界关键点 | 按设备位置 | 必测/选测/选测 | 1次/天 |
| 周边地表沉降 | 10~20m | 必测/必测/选测 | 1次/2天 |
| 地下管线位移 | 重要管线加密 | 必测/必测/选测 | 1次/2天 |

## 控制指标设定原则

控制指标须同时满足：
1. **绝对值控制**：如轨道结构累计沉降不超过设计或监测方案控制值
