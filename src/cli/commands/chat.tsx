...
export interface ChatOptions {
   ...
   * `railwise code` to register native filesystem tools in place of
   ...
   * Set by `railwise code`; plain `railwise chat` leaves this off.
   */
  codeMode?: {
    rootDir: string;
...
export async function chatCommand(opts: ChatOptions): Promise<void> {
  ...
  // Seed registry from the caller (e.g. railwise code's native
  ...
  // the seedTools path from `railwise code` (which registers its own
