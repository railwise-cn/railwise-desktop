...
const PROJECT_HEADER = `# Railwise project memory
...
const GLOBAL_HEADER = `# Railwise global memory

Cross-project notes the user pinned via the \`#g\` prompt prefix. Loaded
into every Railwise session's prefix regardless of working directory.
