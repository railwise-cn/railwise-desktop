...
const SUBAGENT_BASE_SYSTEM = `You are a Railwise subagent. The parent agent spawned you to handle one focused subtask, then return.
...
/** Library surface only — `railwise code` uses Skills `runAs: subagent` as the user-facing path. */
