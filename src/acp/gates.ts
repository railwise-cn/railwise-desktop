/** Bridges Railwise's internal `PauseGate` requests onto ACP `session/request_permission` round-trips. */

import { resolveApprovalPrompt, toApprovalPrompt } from "@railwise/core-utils";
...
export async function requestPermissionForGate(
  ...
  | import("@railwise/core-utils").ConfirmationChoice
  | import("@railwise/core-utils").PlanVerdict
  | import("@railwise/core-utils").CheckpointVerdict
  | import("@railwise/core-utils").RevisionVerdict
  | import("@railwise/core-utils").ChoiceVerdict
> {
