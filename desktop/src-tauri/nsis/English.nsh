...
LangString appRunning ${LANG_ENGLISH} "Railwise is running! Please close it first then try again."
LangString appRunningOkKill ${LANG_ENGLISH} "Railwise is running!$\nClick OK to kill it"
...
LangString failedToKillApp ${LANG_ENGLISH} "Failed to kill Railwise. Please close it first then try again"
