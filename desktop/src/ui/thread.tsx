import type { ApprovalPrompt } from "@railwise/core-utils";
import { isCompactionSummary, stripCompactionMarker } from "@railwise/core-utils/compaction";
import { derivePrefix } from "@railwise/core-utils/derive-prefix";
...
export const AssistantMsg = memo(function AssistantMsg({
  ...
  return (
    <div className="msg assistant">
      ...
      <div className="body">
        <div className="who">
          <span className="name">Railwise</span>
