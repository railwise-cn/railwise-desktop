...
export const de: typeof en = {
  ...
  toast: {
    ...
    aboutLine: "Railwise v{version} · Cache-First-DeepSeek-Agent",
  },
  composer: {
    ...en.composer,
    busy: "railwise denkt nach...",
    idle: "Frag etwas",
    send: "senden",
    newline: "neue Zeile",
    commands: "Befehle",
  ...
  app: {
    ...
    connecting: "Verbinde mit railwise core...",
    startupFailedTitle: "Railwise konnte nicht starten",
  ...
  contextPanel: {
    ...
    mcpHealthTools: "aufrufbare Tools {count}",
  ...
  notifications: {
    ...en.notifications,
    approvalTitle: "Railwise wartet auf Genehmigung",
    inputTitle: "Railwise wartet auf Eingabe",
    planApprovalTitle: "Railwise wartet auf Plan-Genehmigung",
    checkpointApprovalTitle: "Railwise wartet auf Checkpoint-Genehmigung",
    revisionTitle: "Railwise hat eine Plan-Überarbeitung vorgeschlagen",
