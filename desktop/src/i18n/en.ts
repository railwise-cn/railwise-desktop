export const en = {
  ...
  about: {
    sidebarLabel: "About",
    tagline: "Engineering survey & monitoring agent",
    version: "Version",
    repo: "Repository",
  ...
  toast: {
    ...
    aboutLine: "RAILWISE v{version} · engineering survey agent",
  },
  composer: {
    busy: "RAILWISE is thinking…",
    idle: "Ask something",
    send: "send",
    newline: "newline",
    commands: "commands",
  ...
  settings: {
    ...
    themeStyleEmberDesc: "Warm dark palette with a stronger RAILWISE orange accent.",
  ...
  app: {
    ...
    cmd: {
      ...
      railwiseStatus: "Open Railwise readiness",
      railwiseInit: "Create a Railwise project",
    ...
    splashSubtitle: "Engineering Survey Agent",
    connecting: "Connecting to RAILWISE core…",
    startupFailedTitle: "RAILWISE could not start",
    ...
    empty: {
      welcome: "Welcome to RAILWISE",
      currentWorkspace: "Current workspace: ",
      selectWorkspace: "Select a workspace from the top bar first",
      suggestion0: "Import a leveling survey dataset and run adjustment",
      suggestion1: "Check whether these monitoring points exceed limits",
      suggestion2: "Generate a deformation trend chart from the data",
      suggestion3: "Produce a periodic monitoring analysis report",
    },
    setup: {
      welcome: "Welcome to RAILWISE",
      description:
  ...
  statusbar: {
    ...
    tokens: "tokens",
    thisTurn: "this turn",
    railwiseReadiness: "Railwise readiness · ok / warn / fail",
  ...
  mcpCard: {
    ...
    connectedNoTools: "connected, no callable tools",
  ...
  contextPanel: {
    ...
    mcpHealthTools: "callable tools {count}",
    mcpFilterAll: "All",
    ...
    railwiseReadinessTitle: "Railwise readiness",
    railwiseReadinessSummary: "{ok} ok · {warn} warn · {fail} fail",
    railwiseReadinessEmpty: "This workspace does not look like a Railwise engineering project yet.",
    railwiseRefresh: "Refresh",
    railwiseNewProject: "New project",
  ...
  railwiseWizard: {
    title: "New Railwise project",
    desc: "Create a ready-to-use engineering workspace with SOP, sample data, project skills, and Survey MCP config.",
    parent: "Parent folder",
    parentHint: "Choose where the project folder will be created.",
    choose: "Choose",
    name: "Project name",
    nameHint: "A new folder will be created with this name.",
    includes: "Included packet",
    includesDetail:
      "REASONIX.md, project skills, .mcp.json, settlement CSV, CPIII, shield guidance, inclinometer fixtures, SOP, and report template.",
    cancel: "Cancel",
    create: "Create project",
    creating: "Creating...",
    created: "Created Railwise project: {path}",
  },
  sidebarPanel: {
    ...
    weeksAgo: "{n}w ago",
    newChat: "New chat",
    newRailwiseProject: "New Railwise project",
    commandPalette: "Command palette",
    workspace: "Workspace",
  ...
  notifications: {
    approvalTitle: "RAILWISE is waiting for approval",
    inputTitle: "RAILWISE is waiting for input",
    planApprovalTitle: "RAILWISE is waiting for plan approval",
    checkpointApprovalTitle: "RAILWISE is waiting for checkpoint approval",
    revisionTitle: "RAILWISE proposed a plan revision",
    commandBody: "Command: {command}",
    readBody: "Read: {path}",
    writeBody: "Write: {path}",
    turnCompleteTitle: "RAILWISE task complete",
