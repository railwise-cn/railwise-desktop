...
export const zhCN: typeof en = {
  ...
  toast: {
    ...
    aboutLine: "睿威智测 RAILWISE DeepSeek 版 v{version} · 工程测量智能体",
  },
  composer: {
    busy: "睿威智测 正在思考…",
    idle: "问点什么",
  ...
  settings: {
    ...
    themeStyleEmberDesc: "暖黑深色风格，强化 睿威智测 橙色品牌感。",
  ...
  statusbar: {
    ...
    tokens: "tokens",
    thisTurn: "本次",
    railwiseReadiness: "Railwise 就绪状态 · 正常 / 警告 / 失败",
  ...
  app: {
    ...
    cmd: {
      ...
      railwiseStatus: "打开 Railwise 就绪状态",
      railwiseInit: "创建 Railwise 项目",
    ...
    dismissError: "关闭",
    jumpToBottom: "回到底部",
    splashSubtitle: "工程测量智能体",
    connecting: "正在连接 睿威智测 内核…",
    startupFailedTitle: "睿威智测 无法启动",
    ...
    empty: {
      ...
      suggestion0: "导入一期水准测量数据并做平差计算",
      suggestion1: "检查这批监测点的变形是否超限",
      suggestion2: "根据监测数据生成变形趋势图",
      suggestion3: "生成一份阶段性监测分析报告",
    },
    setup: {
      welcome: "欢迎使用 睿威智测",
  ...
  contextPanel: {
    ...
    mcpHealthReady: "可用 {count}",
    mcpHealthFailed: "失败 {count}",
    mcpHealthTools: "可调用工具 {count}",
    mcpFilterAll: "全部",
    mcpFilterReady: "可用",
    mcpFilterFailed: "失败",
    ...
    mcpRetryAll: "重试失败项",
    mcpSettings: "设置",
    railwiseReadinessTitle: "Railwise 就绪状态",
    railwiseReadinessSummary: "{ok} 正常 · {warn} 警告 · {fail} 失败",
    railwiseReadinessEmpty: "当前工作区还不是 Railwise 工程项目。",
    railwiseRefresh: "刷新",
    railwiseNewProject: "新建项目",
    memoryTitle: "长期记忆",
    itemCount: "{count} 项",
    scopeProject: "项目",
    scopeGlobal: "全局",
  ...
  railwiseWizard: {
    title: "新建 Railwise 项目",
    desc: "一键创建可用工程工作区，包含 SOP、样例数据、项目技能和 Survey MCP 配置。",
    parent: "父级目录",
    parentHint: "选择项目文件夹要创建到哪里。",
    choose: "选择",
    name: "项目名称",
    nameHint: "将按此名称创建新文件夹。",
    includes: "包含内容",
    includesDetail:
      "REASONIX.md、项目技能、.mcp.json、沉降 CSV、CPIII、盾构导向、测斜 fixture、SOP 与报告模板。",
    cancel: "取消",
    create: "创建项目",
    creating: "创建中...",
    created: "已创建 Railwise 项目：{path}",
  },
  sidebarPanel: {
    ...
    weeksAgo: "{n} 周前",
    newChat: "新会话",
    newRailwiseProject: "新建 Railwise 项目",
    commandPalette: "命令面板",
    workspace: "工作目录",
    noWorkspace: "未选择",
