...
export const ja: typeof en = {
  ...
  toast: {
    ...
    aboutLine: "Railwise v{version} · キャッシュファーストDeepSeekエージェント",
  },
  composer: {
    busy: "railwiseが考え中…",
    idle: "質問する",
  ...
  settings: {
    ...
    themeStyleEmberDesc: "Railwiseのオレンジを強めた暖かいダークパレット。",
  ...
  app: {
    ...
    cmd: {
      ...
      railwiseStatus: "Railwise就緒状態を開く",
      railwiseInit: "Railwiseプロジェクトを作成",
    ...
    splashSubtitle: "エンジニアリング測量エージェント",
    connecting: "railwiseコアに接続中…",
    startupFailedTitle: "Railwiseを起動できませんでした",
  ...
  statusbar: {
    ...
    tokens: "トークン",
    thisTurn: "このターン",
    railwiseReadiness: "Railwise就緒状態 · 正常 / 警告 / 失敗",
  ...
  contextPanel: {
    ...
    mcpHealthReady: "利用可能 {count}",
    mcpHealthFailed: "失敗 {count}",
    mcpHealthTools: "呼び出し可能ツール {count}",
    mcpFilterAll: "すべて",
    mcpFilterReady: "利用可能",
    mcpFilterFailed: "失敗",
    ...
    mcpSettings: "設定",
    railwiseReadinessTitle: "Railwise就緒状態",
    railwiseReadinessSummary: "{ok} 正常 · {warn} 警告 · {fail} 失敗",
    railwiseReadinessEmpty: "このワークスペースはまだRailwiseエンジニアリングプロジェクトではありません。",
    railwiseRefresh: "更新",
    railwiseNewProject: "新規プロジェクト",
    memoryTitle: "長期メモリ",
    itemCount: "{count} 項目",
    scopeProject: "プロジェクト",
    scopeGlobal: "グローバル",
  ...
  sidebarPanel: {
    ...
    weeksAgo: "{n}週間前",
    newChat: "新しいチャット",
    newRailwiseProject: "新規Railwiseプロジェクト",
    commandPalette: "コマンドパレット",
    workspace: "ワークスペース",
  ...
  notifications: {
    approvalTitle: "Railwiseが承認待ちです",
    inputTitle: "Railwiseが入力を待っています",
    planApprovalTitle: "Railwiseがプラン承認待ちです",
    checkpointApprovalTitle: "Railwiseがチェックポイント承認待ちです",
    revisionTitle: "Railwiseがプラン修正を提案しました",
    commandBody: "コマンド: {command}",
    readBody: "読み取り: {path}",
    writeBody: "書き込み: {path}",
    turnCompleteTitle: "Railwiseタスク完了",
